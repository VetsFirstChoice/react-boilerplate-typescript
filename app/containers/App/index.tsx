      ...
      <Layout>
        ...
        >
          ...
          <Menu mode="inline" defaultSelectedKeys={['1']}>
            ...
            <Menu.Item key="4"><Link to="/products"><Icon type="shop" theme="twoTone"/>Products</Link></Menu.Item>
            <Menu.Item key="5">
              <Link to="/exceptions"><Icon type="warning" theme="twoTone"/>Exceptions</Link>
            </Menu.Item>
            <Menu.Item key="6"><Link to="/autoship"><Icon type="schedule" theme="twoTone"/>Autoship</Link></Menu.Item>
          </Menu>
        </Sider>
        <Layout>
